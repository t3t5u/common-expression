...
public class Match<T extends Serializable, M extends Matcher<T>> extends AbstractBinaryExpression<T, M, Boolean> implements MatchingExpression<T, M> {
	Match(final Expression<T> leftExpression, final MatcherExpression<T, M> rightExpression) {
